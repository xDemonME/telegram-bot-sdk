...
trait Message
{
     ...
     *        'from_chat_id'                  => '',  // int        - Required. Unique identifier for the chat where the original message was sent (or channel username in the format "@channelusername")
     *        'message_ids'                   => '',  // array      - Required. List of 1-100 identifiers of messages in the chat from_chat_id to copy
     *        'disable_notification'          => '',  // bool       - (Optional). Sends the message silently. Users will receive a notification with no sound.
     *        'protect_content'               => '',  // bool       - (Optional). Protects the contents of the sent message from forwarding and saving
     *        'reply_to_message_id'           => '',  // int        - (Optional). If the message is a reply, ID of the original message
     *  ]
     ...
     * @throws TelegramSDKException
     */
    public function copyMessages(array $params): MessageObject
    {
